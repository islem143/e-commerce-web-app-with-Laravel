  ...
  <div class=" flex flex-col justify-between p-3 ">
      ...
      <div>
        ...
        <form action="" class="flex flex-col">
            ...
            <div class="mb-4">
             <input class="bg-gray-100 w-full p-3 border border-1 rounded-lg" type="password" name=""  placeholder="Email">
            </div>
            <div class="mb-4">
             <input class="bg-gray-100 w-full p-3 border border-1 rounded-lg" type="number" name=""  placeholder="Phone">
            </div>
            <div class="mb-4">
