...
<div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-7 w-10/12 mx-auto mt-20 ">
  ...
  <div class="card p-8 bg-blue-500 text-white hover:bg-blue-400">
      <span class="block font-light mb-4 tracking-wider"> Orders Today</span>
    ...
    <table class="w-full ">
      <thead class="bg-gray-50 border-b-2 border-gray-200">
        <tr >
          ...
          <th class="p-2 text-sm font-semibold tracking-wide text-left">Order</th>
          <th class="p-2 text-sm font-semibold tracking-wide text-left">Product_ID</th>
          <th class="p-2 text-sm font-semibold tracking-wide text-left">Customer_ID</th>
